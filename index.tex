...
\c{\urlh{../index.html}{Dorai Sitaram}}
%
\ifx\inpltdist\Undefined
\ifx\shipout\UnDeFiNeD
\c{Download
\urlh{tex2page.tar.bz2}{Version
...
like making clocks.}
--- Jean de la Bruy\`ere (\dag 1696)
}

%French original:
%``C'est un m\'etier que de faire un livre,
...
If you use \XeTeX, continue to use \p{epsf.tex} or \p{epsfig.sty} as
...
%
Go to the \urlp{\TeX2page
website}{http://www.ccs.neu.edu/~dorai/tex2page/index.html}
to download the \TeX2page distribution.
(The download link immediately follows the title.)

\TeX2page is distributed as a \p{bzip2}'d \p{tar} file,
\p{tex2page.tar.bz2}.  Unpacking it produces a directory
...
First ensure that
\urlp{Scmxlate}{http://www.ccs.neu.edu/~dorai/scmxlate/index.html}
