...
English. To set it to another language, set the control sequence
`\TZPlang` to the ISO 639-1 code for that language, e.g.,
...
\endtt
%
sets {\color[RGB]{0,49,83} `all verbatim text
in Prussian blue`}.
