...
\message{version 20161120} % last change
...
\def\activettchar#1{%
  \ifx\activettcharQprev\UnDeFiNeD\else
  \catcode\activettcharQprev \activettcharQprevQcatcode
  \fi
  \chardef\activettcharQprev`#1%
  \chardef\activettcharQprevQcatcode \catcode`#1%
